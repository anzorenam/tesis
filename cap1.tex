...
El descubrimiento de la radiación de fondo de microondas (CMB por su siglas en inglés) constituye uno de nuestros más grandes hallazgos, en ella se encuentran las evidencias de nuestro origen: fotones provenientes del \emph{big bang} corridos hacia la banda de microondas en su largo viaje desde los rincones del universo en expansión. A gran escala, el CMB es isotrópico pues el universo no tiene una dirección preferente para su evolución. Son sin embargo las diminutas fluctuaciones en su espectro la característica más impactante, ya que brindan la evidencia necesaria para la formación de materia y galaxias a partir de los hechos ocurridos hace miles de millones de años.
